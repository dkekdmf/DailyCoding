...
//
//        // 🎯 [정밀 수술 완료] 누락되었던 4번째 인자 onPhotoClick 리스너 파이프라인을 성공적으로 수혈했습니다!
//        diaryAdapter = DiaryAdapter(
//            items = displayList,
//            onItemClick = { item ->
//                // 기존 순정 상세 클릭 기능 유지
//                Log.d("JaehoonLog", "일지 아이템 클릭됨: ${item.title}")
//            },
//            onDotClick = { position ->
//                // 기존 순정 더보기 옵션 클릭 기능 유지
//                Log.d("JaehoonLog", "옵션 버튼 클릭됨 포지션: $position")
//            },
//            onPhotoClick = { clickedItem ->
//                // 📸 [사진 인증샷 연동] 하단 일지 목록의 사진 마크를 터치하면 디코딩하여 큰 액자로 표출!
...
//    }
//
//    // 🎯 [신규 헬퍼 추가] 대용량 Base64 스트링 원본을 복원해 중앙에 다이얼로그 창으로 안전하게 띄워주는 액자형 이미지 뷰어 시스템
...
//                setPadding(40, 40, 40, 40) // 내부 액자 여백 균등 배정
//            }
//
//            builder.setTitle("$dateText")
//                .setView(imageView)
