    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (isCurrentSelected) {
          //  holder.tvDayNumber.setTypeface(null, Typeface.BOLD)
            holder.tvDayOfWeek.setTextColor(Color.parseColor("#2E3D4F"))
            holder.tvDayNumber.setTextColor(Color.parseColor("#2E3D4F"))
        } else {
           // holder.tvDayNumber.setTypeface(null, Typeface.NORMAL)
            holder.tvDayOfWeek.setTextColor(Color.parseColor("#8896A8"))
            holder.tvDayNumber.setTextColor(Color.parseColor("#D8E1ED"))
        }
